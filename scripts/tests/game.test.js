...
describe("game object contains correct keys", () => {
    ...
    // Add a sixth failing test to check if the turn number key exists
    test("turnNumber key exist", () => {
        expect("turnNumber" in game).toBe(true);
    });
    // Add a seventh failing test to check if the lastButton exists
    test("lastButton key exists", () => {
        expect("lastButton" in game).toBe(true);
    });
    // Add test to check if the turnInProgress key exists
    test("turnInProgress key exists", () => {
        expect("turnInProgress" in game).toBe(true);
    });
    // Add test to check if turnInProgress key value is false
...
describe("gameplay works correctly", () => {
    ...
    // Add test to fail when clicking during computer sequence
